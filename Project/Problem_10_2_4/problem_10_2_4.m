...
A1 = [0 1 0 0;
      0 0 -K_2 0;
      0 0 0 1;
      0 0 -K_1*K_pp -K_1*K_pd] * delta_t + eye(4); % A1 = (TA + I)
...
% set_param('helicopter','SimulationCommand','start')
%genPlotFile('P2', 'Travel', 'Travel [deg]', t_out, u_seq, lambda_out, 'Travel [deg]');

% genPlotFile(prefix, titleString, yString, t, reference, state, stateLegend)