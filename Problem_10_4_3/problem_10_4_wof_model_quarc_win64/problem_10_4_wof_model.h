...
#ifndef RTW_HEADER_problem_10_4_wof_model_h_
#define RTW_HEADER_problem_10_4_wof_model_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef problem_10_4_wof_model_COMMON_INCLUDES_
# define problem_10_4_wof_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* problem_10_4_wof_model_COMMON_INCLUDES_ */

#include "problem_10_4_wof_model_types.h"
...
#define problem_10_4_wof_model_rtModel RT_MODEL_problem_10_4_wof_mod_T
...
#define rtB                            problem_10_4_wof_model_B
#define BlockIO                        B_problem_10_4_wof_model_T
#define rtX                            problem_10_4_wof_model_X
#define ContinuousStates               X_problem_10_4_wof_model_T
#define rtXdot                         problem_10_4_wof_model_XDot
#define StateDerivatives               XDot_problem_10_4_wof_model_T
#define tXdis                          problem_10_4_wof_model_XDis
#define StateDisabled                  XDis_problem_10_4_wof_model_T
#define rtP                            problem_10_4_wof_model_P
#define Parameters                     P_problem_10_4_wof_model_T
#define rtDWork                        problem_10_4_wof_model_DW
#define D_Work                         DW_problem_10_4_wof_model_T

/* Parameters (auto storage) */
struct P_problem_10_4_wof_model_T_ {
...
struct tag_RTM_problem_10_4_wof_mode_T {
  const char_T *path;
...
extern P_problem_10_4_wof_model_T problem_10_4_wof_model_P;

/* Block signals (auto storage) */
extern B_problem_10_4_wof_model_T problem_10_4_wof_model_B;

/* Continuous states (auto storage) */
extern X_problem_10_4_wof_model_T problem_10_4_wof_model_X;

/* Block states (auto storage) */
extern DW_problem_10_4_wof_model_T problem_10_4_wof_model_DW;

/* Model entry point functions */
extern void problem_10_4_wof_model_initialize(void);
extern void problem_10_4_wof_model_output(void);
extern void problem_10_4_wof_model_update(void);
extern void problem_10_4_wof_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern problem_10_4_wof_model_rtModel *problem_10_4_wof_model(void);
...
extern RT_MODEL_problem_10_4_wof_mod_T *const problem_10_4_wof_model_M;
 ...
 *
 * '<Root>' : 'problem_10_4_wof_model'
 * '<S1>'   : 'problem_10_4_wof_model/Conversion'
 * '<S2>'   : 'problem_10_4_wof_model/Degrees to Radians'
 * '<S3>'   : 'problem_10_4_wof_model/Elevation controller'
 * '<S4>'   : 'problem_10_4_wof_model/Helicopter_interface'
 * '<S5>'   : 'problem_10_4_wof_model/Pitch controller'
 * '<S6>'   : 'problem_10_4_wof_model/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'problem_10_4_wof_model/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'problem_10_4_wof_model/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'problem_10_4_wof_model/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'problem_10_4_wof_model/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'problem_10_4_wof_model/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'problem_10_4_wof_model/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_problem_10_4_wof_model_h_ */
