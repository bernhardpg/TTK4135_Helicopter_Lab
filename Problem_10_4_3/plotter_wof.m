...
saveas(gcf, 'problem_10_4_wof_plot_pitch','epsc');
savefig('problem_10_4_wof_plot_pitch');
...
saveas(gcf, 'problem_10_4_wof_plot_travel','epsc');
savefig('problem_10_4_wof_plot_travel');
...
saveas(gcf, 'problem_10_4_wof_plot_elevation','epsc');
savefig('problem_10_4_wof_plot_elevation');