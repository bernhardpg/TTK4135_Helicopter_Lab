...
#ifndef RTW_HEADER_problem_10_4_wf_model_h_
#define RTW_HEADER_problem_10_4_wf_model_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef problem_10_4_wf_model_COMMON_INCLUDES_
# define problem_10_4_wf_model_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* problem_10_4_wf_model_COMMON_INCLUDES_ */

#include "problem_10_4_wf_model_types.h"
...
#define problem_10_4_wf_model_rtModel  RT_MODEL_problem_10_4_wf_mode_T
...
typedef struct {
  ...
  real_T u[2];                         /* '<Root>/u' */
  real_T Sum3_j[6];                    /* '<S5>/Sum3' */
  real_T Gain_k[2];                    /* '<S5>/Gain' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ElevationRateScopedegs_PWORK;      /* '<S4>/Elevation Rate: Scope [deg//s]' */
  ...
  struct {
    void *LoggedData;
  } PitchrateScopedegs_PWORK;          /* '<S4>/Pitch rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } PitchrateScopedegs1_PWORK;         /* '<S4>/Pitch rate: Scope [deg//s]1' */
  ...
  struct {
    int_T PrevIndex;
  } x_star_IWORK;                      /* '<S5>/x_star' */
} DW_problem_10_4_wf_model_T;
...
#define rtB                            problem_10_4_wf_model_B
#define BlockIO                        B_problem_10_4_wf_model_T
#define rtX                            problem_10_4_wf_model_X
#define ContinuousStates               X_problem_10_4_wf_model_T
#define rtXdot                         problem_10_4_wf_model_XDot
#define StateDerivatives               XDot_problem_10_4_wf_model_T
#define tXdis                          problem_10_4_wf_model_XDis
#define StateDisabled                  XDis_problem_10_4_wf_model_T
#define rtP                            problem_10_4_wf_model_P
#define Parameters                     P_problem_10_4_wf_model_T
#define rtDWork                        problem_10_4_wf_model_DW
#define D_Work                         DW_problem_10_4_wf_model_T

/* Parameters (auto storage) */
struct P_problem_10_4_wf_model_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T Travel_offset_Value;          /* Expression: 180
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T elavation_offsetdeg_Value;    /* Expression: -25
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Saturation_UpperSat;          /* Expression: 30*pi/180
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Saturation_LowerSat;          /* Expression: -30*pi/180
                                        * Referenced by: '<Root>/Saturation'
                                        */
...
struct tag_RTM_problem_10_4_wf_model_T {
  const char_T *path;
...
extern P_problem_10_4_wf_model_T problem_10_4_wf_model_P;

/* Block signals (auto storage) */
extern B_problem_10_4_wf_model_T problem_10_4_wf_model_B;

/* Continuous states (auto storage) */
extern X_problem_10_4_wf_model_T problem_10_4_wf_model_X;

/* Block states (auto storage) */
extern DW_problem_10_4_wf_model_T problem_10_4_wf_model_DW;

/* Model entry point functions */
extern void problem_10_4_wf_model_initialize(void);
extern void problem_10_4_wf_model_output(void);
extern void problem_10_4_wf_model_update(void);
extern void problem_10_4_wf_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern problem_10_4_wf_model_rtModel *problem_10_4_wf_model(void);
...
extern RT_MODEL_problem_10_4_wf_mode_T *const problem_10_4_wf_model_M;
 ...
 *
 * '<Root>' : 'problem_10_4_wf_model'
 * '<S1>'   : 'problem_10_4_wf_model/Conversion'
 * '<S2>'   : 'problem_10_4_wf_model/Degrees to Radians'
 * '<S3>'   : 'problem_10_4_wf_model/Elevation controller'
 * '<S4>'   : 'problem_10_4_wf_model/Helicopter_interface'
 * '<S5>'   : 'problem_10_4_wf_model/Optimal feedback'
 * '<S6>'   : 'problem_10_4_wf_model/Pitch controller'
 * '<S7>'   : 'problem_10_4_wf_model/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'problem_10_4_wf_model/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'problem_10_4_wf_model/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'problem_10_4_wf_model/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'problem_10_4_wf_model/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'problem_10_4_wf_model/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'problem_10_4_wf_model/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_problem_10_4_wf_model_h_ */
